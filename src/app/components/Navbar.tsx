...
// const navItems = [
//   { label: "Platform", href: "/platform", hasPreview: true },
//   { label: "Regulations", href: "/Regulations", hasPreview: true },
//   { label: "Why us", href: "/whyus" },
//   { label: "Resources", href: "/resources", hasPreview: true },
...
//                 key={item.label}
//                 className="relative"
//                 onMouseEnter={() => item.hasPreview && setActivePreview(item.label)}
//                 onMouseLeave={() => item.hasPreview && setActivePreview("")}
//               >
//                 <Link 
//                   href={item.href} 
//                   prefetch={true} 
...
//                 {/* Preview Content */}
//                 {activePreview === item.label && item.hasPreview && (
//                   <div 
//                     className="fixed inset-0 top-20 left-0 right-0 bottom-0 z-50 bg-white shadow-2xl overflow-auto"
//                     onMouseEnter={() => setActivePreview(item.label)}
//                     onMouseLeave={() => setActivePreview("")}
//                   >
//                     <div className="w-full h-full">
//                       {renderPreview(item.label)}
//                     </div>
//                   </div>
//                 )}
//               </div>
...
//           <Image src="/logo.png" alt="CarbonScan.ai" width={120} height={30} />
//           <button
//             onClick={toggleMobileMenu}
//             className="p-2"
//             aria-label="Close mobile menu"
//           >
//             <span className="w-6 h-0.5 bg-white block rotate-45 translate-y-0.5"></span>
//             <span className="w-6 h-0.5 bg-white block -rotate-45 -translate-y-0.5"></span>
//           </button>
//         </div>
...
//                 href={item.href} 
//                 prefetch={true} 
//                 className={`block font-normal py-3 border-b border-gray-600 transition-colors ${
//                   isActive 
//                     ? 'text-[#6EED88] bg-[#2A4A4A] px-2 -mx-2 rounded' 
//                     : 'text-[#ffffff] hover:text-[#6EED88]'
//                 }`}
//                 onClick={toggleMobileMenu}
//               >
//                 {item.label}
