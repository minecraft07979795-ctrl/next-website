          ...
          <div className="relative z-10 text-center">
            ...
            <form onSubmit={handleSubscribe} className="max-w-md mx-auto">
              ...
              <button
                  ...
                  className="px-8 py-3 bg-gray-900 border border-black text-bllalck rounded-lg font-medium hover:bg-gray-800 focus:outline-none focus:ring-2 focus:ring-black focus:ring-offset-2 transition-colors duration-200 disabled:bg-green-600 disabled:cursor-not-allowed"
                >
