...
export default function Dpp() {
  ...
  return (
    <div className="relative w-full h-screen overflow-hidden">
      ...
      {/* Content */}
      <div className="relative z-20 flex h-full bottom-20 flex-col lg:flex-row items-center justify-center p-4 lg:p-10">
        {/* Left Panel */}
        <div className="w-full lg:w-3/5 flex items-center justify-center">
          <div className="bg-green-900/60 backdrop-blur-xl p-6 lg:p-10 rounded-lg text-white max-w-3xl">
            <h1 className="text-3xl lg:text-5xl font-bold mb-6 text-center lg:text-left">
              The Textile Passport - DPP
            </h1>

            <p className="mb-4 text-base lg:text-lg leading-relaxed text-center lg:text-left">
              The Textile Passport is a <span className="font-bold">digital identity</span> for every garment, storing
              verified details on materials, recycled content, and country of origin. With the Textile Passport, brands
              can create <span className="font-bold">traceable and recyclable products</span>, map every stage of the
              supply chain, and consolidate all important data—such as carbon footprint and ESG metrics—on one platform.
            </p>

            <p className="mb-6 text-base lg:text-lg leading-relaxed text-center lg:text-left">
              Demonstrate compliance with <span className="font-bold">EU Digital Product Passport regulations</span>,
              GOTS, OEKO-TEX®, and other sustainability standards, while tracking critical materials and production
              methods across the textile supply chain.
            </p>
