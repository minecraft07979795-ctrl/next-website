...
const faqs = [
  {
    question: "What is Carbon Capture & Utilization (CCU)?",
    answer:
  ...
  {
    question: "How is CCU different from traditional Carbon Capture & Storage (CCS)?",
    answer:
