...
const faqs = [
  {
    question: "What is carbon accounting and why is it important for Malaysian companies?",
    answer:
  ...
  {
    question: "Is carbon accounting mandatory in Malaysia?",
    answer:
