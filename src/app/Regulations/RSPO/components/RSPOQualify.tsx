...
export default function RSPOQualify(){
  ...
  return (
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-1 md:grid-cols-2 gap-8 items-start">
        ...
        <div className="flex justify-center md:justify-start">
          <Image
            src="/rsposmall.png" // 👈 place your small card image in /public
            alt="CarbonScan card"
            width={800}
            height={800}
        ...
        <div className="relative flex justify-center md:justify-start">
          <Image
            src="/rspobig.png" // 👈 place your big card image in /public
          ...
          <div className="absolute bottom-10 left-0 right-[40%] flex justify-center">
            <button className="bg-[#8DD95B] hover:bg-[#8dd95bca] text-white font-medium rounded-lg px-6 py-2 shadow-md transition">
              Know more →
            </button>
          </div>
        </div>
