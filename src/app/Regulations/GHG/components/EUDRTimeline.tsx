...
export default function BURSATimeline(){
  ...
  const timelineData: TimelineItem[] = [
    {
      year: '2023',
      // title: 'EUDR Adoption',
      title: 'Bursa announces alignment with IFRS S1 & S2 sustainability disclosure standards',
      isActive: false,
      color: 'bg-green-400',
    ...
    },
    {
      ...
      title: 'Preparatory phase; issuers begin aligning systems, data, and governance for reporting',
      isActive: false,
      color: 'bg-green-400',
      textColor: 'text-green-400'
    },
    {
      year: '2025',
      // title: 'SME Inclusion',
      title: 'Large Main Market issuers (≥RM2 billion market cap) must comply from financial year 2025',
      isActive: false,
      color: 'bg-green-400',
      textColor: 'text-green-400'
    },
    {
      ...
      title: 'All other Main Market issuers must comply from financial year 2026',
      isActive: false,
      color: 'bg-green-400',
      textColor: 'text-green-400'
    },
    {
      year: '2027',
      // title: 'ACE',
      title: 'ACE Market issuers must comply from financial year 2027',
      isActive: false,
      color: 'bg-green-400',
      textColor: 'text-green-400'
    },
    {
      ...
      title: 'ESG reporting expected to expand with mandatory external assurance and broader disclosure requirements',
      isActive: true,
      color: 'bg-slate-700',
